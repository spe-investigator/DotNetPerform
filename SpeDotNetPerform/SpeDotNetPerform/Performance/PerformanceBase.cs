...
namespace System.Performance {
    public class PerformanceBase<T> where T : class, new() {
        [ThreadStatic]
        ...
        //protected PerformanceBase(PerformanceCharacteristic characteristic, int maximumRetained, IPooledObjectPolicyFactory pooledObjectPolicyFactory = null, ObjectPool<T> objectPool = null) {
        //    _characteristic = characteristic;

        //    if (_pooledObjectPolicy == null) {
        //        _pooledObjectPolicy = pooledObjectPolicyFactory.GetPooledObjectPolicy<T>();
        //    }
        ...
        //        _objectPool = objectPool ?? new DefaultObjectPool<T>(_pooledObjectPolicy, maximumRetained);
        ...
        protected PerformanceBase(PerformanceCharacteristic characteristic, int maximumRetained, string poolKey = null, PooledObjectPolicy<T> pooledObjectPolicy, Func<IPooledObjectPolicy<T>, int, ObjectPool<T>> objectPoolFactory = null) {
            _characteristic = characteristic;
